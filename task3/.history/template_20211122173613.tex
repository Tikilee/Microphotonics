...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.35\textwidth]{img/fig1.1a.jpg} % set width to get a proper ratio
...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.35\textwidth]{img/fig1.2a.jpg} % set width to get a proper ratio
...
T distribution of dft\_wg\_output is shown in Fig \ref{fig3.2.png} , =1538.03nm.T of dft_wg_output in bend_coupler.fsp at   is 0.905347 .For  =3.109, the FWHM can be calculated by the formula ,FWHM= ((1-r^2)λ^2 res )/πngLr .Finally, FWHM=958.6pm.
\begin{figure}[H]
    \centering
