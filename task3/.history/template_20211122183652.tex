...
It is available when studying the fundamental mode of the center 
...
The upper row is linear,
and the lower row is logarithmic.
...
\end{equation}
 ...
 \begin{figure}[H]
    \centering
     ...
     \caption{T distribution of dft\_wg\_output at $\mathrm{gap}=0.125\mathrm{um}$}
     \label{fig3.3}
\end{figure}  
