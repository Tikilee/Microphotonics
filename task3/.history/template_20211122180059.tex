...
\end{equation}
 ...
 Go back to the ring\_add\_drop.fsp, simulate with $gap=0.26um $,ring-radius=4.26um.Comparing to the situation at gap=0.125um ,ring-radius=4.26um,there is no apparent difference at  ,which is shown in Figure 3.3.The red curve is gap=0.26um ,ring-radius=4.26um,and the green curve is gap=0.125um ,ring-radius=4.26um.
%=================================================================================================
\pagebreak
