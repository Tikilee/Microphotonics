...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.7\textwidth]{img/fig1.1.png}
...
\subsection{}
%-------------------------------------------------------------------------------------------------
Set $D$ to $0.1\mathrm{\mu m}$ and period to $0.917\mathrm{\mu m}$,and run the simulation,we can get figure 1-2,which show most of plane wave that propagates in the 0°direction,and a few propagates in 45°and -45°direction.
%-------------------------------------------------------------------------------------------------
\subsection{SUB-CHAPTE}
%-------------------------------------------------------------------------------------------------
Here comes some text. This text makes use of 1.5 line spacing. 
%=================================================================================================
\pagebreak
