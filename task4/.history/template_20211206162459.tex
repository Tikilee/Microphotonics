...
\subsection{}
%-------------------------------------------------------------------------------------------------
From Figure \ref{} of the $k$-vector diagram of surface grating, 
the period of surface grating is calculated as 0.917um.
\section{\uline{Distributed Bragg Refector}}
\begin{figure}[H]
    \centering
     \includegraphics[width=0.35\textwidth]{img/1.png}
     \caption{diagram of the waveguide grating}
     \label{name1}
\end{figure}
%-------------------------------------------------------------------------------------------------
