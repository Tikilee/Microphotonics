...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.3\textwidth]{img/fig1.1.png}
...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.3\textwidth]{img/fig1.3.png}
...
From Figure \ref{fig1.5}, an analytical expression can be figured out as
 k_0 ((D+Λ)n〖-n〗_0 D)=2πm.For λ=1.55um,Λ=0.917 um,n=2.39,n_0=1 and m=2,the D equal to 0.6536 um.Then adjust the parameters,and run the simulation again,we can also see apparent improvement in figure 1-6.
