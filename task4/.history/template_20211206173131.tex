...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{k-dia-BR.png}
    \caption{\kappa vector diagram}
    \label{k-dia-BR}
\end{figure}
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{n2.4_mov.png}
    \includegraphics[width=0.4\textwidth]{n2.4_T.png}
...
the result is shown in Figture \ref{n2.4_propa}. Obviosly, it is not what we expect.
The smllest transmission is not at $\lambda=1.55\mu m$. We think it is because the air surounding and boundary condition or other
reason that have influences on the effective refractive index. If the simulation is real,
the real $n_{eff}$ should meet,\\
$$ \frac{\lambda '}{2n_{eff }'}=\frac{\lambda }{2n_{eff }}$$
Then, wen get $n_{eff}=2.346$ and $\Lambda=0.3304$. In the simulation, we get the reflectivity is about 0.972.
According to formula 6.87, we calculate $\kappa$,
$$\kappa=\frac 1{2N\Lambda}\ln{\frac{1+\sqrt R}{1-\sqrt R}}=0.250 \mu m^{-1}$$
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.4\textwidth]{n2.3._Tpng.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{kappa.png}
