...
The reason is that n_eff is smaller than the theoretical value $2.4$ 
for the periodic structure. The effective refractive index of unetched part waveguide is 2.4,but the etched part is smaller than 2.4,so the effective refractive index of the whole waveguide is smaller than 2.4 .
\begin{figure}[H]
    \centering
