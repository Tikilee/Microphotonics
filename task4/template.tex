...
\end{equation} 
When $\lambda=1.55\mathrm{\mu m}$, $n=2.39$, $n_0=1$ and $m=1$, we get $D=0.6513\mathrm{\mu m}$. 
...
\end{equation}
When $\lambda=1.55\mathrm{\mu m}$, $\Lambda=0.917\mathrm{\mu m}$, 
...
the result is shown in Figure \ref{n2.4_porpa}. Obviously, it is not what we expect.
