...
CAD-LAB: Scatter Matrices%SUBTITLE
}}\vspace{10mm}
...
We choos the fileter lossless, and ring length with $2L=80\times \frac{\lambda}{n_{neff}}$.
If we want to make steeeper edges, we could make $\tau$ smaller, as shown in Figure \ref{t4_3}.
It has steepter edges than Figure \ref{t2_3}.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{img/bonus1.png}
    \includegraphics[width=0.5\textwidth]{img/bonus2.png}
    \caption{Transmission distribution (dB) of drop (blue) and pass (orange),ring with $\tau=0.98$}
    \label{t4_3}
\end{figure}
