...
which corresponds to the ring length $2L_1 = 63.15\mathrm{\mu m}$. 
...
\end{equation}
In order to filter the lights of which wavelength is near $1550 \mathrm{nm}$,
consider the free spectral range of the second filter 
${\Delta \lambda_{F S R}}_2$ is smaller or longer of $3\Delta \lambda_{3 d B}$
